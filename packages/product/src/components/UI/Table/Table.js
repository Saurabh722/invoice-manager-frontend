        ...
        <TableBody>
          {rows?.map((row) => (
            <StyledTableRow key={row.name}>
              ...
              {actions && (
                <StyledTableCell>
                  <Button variant="outlined" onClick={() => actions.edit.onClick(row['productId'])}>{actions.edit.label}</Button>
                  <Button variant="outlined" onClick={() => actions.delete.onClick(row['productId'])}>{actions.delete.label}</Button>
                </StyledTableCell>
              )}
            </StyledTableRow>
          ))}
